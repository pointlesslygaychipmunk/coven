...
export class GameHandler {
    ...
    waterPlants(playerId: string): GameState { console.log(`[GameHandler] Water action: P:${playerId}`); this.engine.waterPlants(playerId); return this.engine.getState(); } // Removed unused success param
