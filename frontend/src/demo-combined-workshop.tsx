...
const Demo = () => {
  ...
  const mockData = {
    ...
    onDesignCreate: (design: any) => { console.log('Design created:', design); return Promise.resolve(); },
    onApplyToProduct: (design: any, product: any) => { console.log('Design applied:', design, product); return Promise.resolve(); }
  };
