...
const Garden = ({ plots, inventory, onPlant, onHarvest, onWater, onProtect, onCrossBreed, weatherFate = 'normal', season = 'Spring', moonPhase = 'Full Moon', playerSkills }) => {
    ...
    const [miniGameType, setMiniGameType] = useState('planting');
    ...
    const handlePlantingComplete = (result) => {
        if (selectedPlotId === null || !selectedSeedId)
            return;
    ...
    const handleHarvestingComplete = (result) => {
        if (selectedPlotId === null)
            return;
    ...
    const handleWateringComplete = (result) => {
        if (selectedPlotId === null)
            return;
    ...
    const renderMoonPhaseIndicator = () => {
        ...
        return (_jsxs("div", { className: "moon-indicator", children: [_jsx("div", { className: "moon-icon", children: icon }), _jsx("div", { className: "moon-label", children: moonPhase })] }));
    };
    ...
    const renderPlotDetails = () => {
        ...
        return (_jsxs("div", { className: "plot-details", children: [_jsxs("div", { className: "scroll-header", children: [_jsx("div", { className: "scroll-ornament left" }), _jsxs("h3", { children: ["Plot ", selectedPlot.id + 1] }), _jsx("div", { className: "scroll-ornament right" })] }), _jsxs("div", { className: "parchment-content", children: [_jsxs("div", { className: "plot-stats", children: [_jsxs("div", { className: "plot-stat", children: [_jsxs("div", { className: "stat-label", children: [_jsx("span", { children: "Fertility" }), _jsxs("span", { children: [selectedPlot.fertility || 0, "%"] })] }), _jsx("div", { className: "stat-bar", children: _jsx("div", { className: "stat-fill fertility", style: { width: `${selectedPlot.fertility || 0}%` } }) })] }), _jsxs("div", { className: "plot-stat", children: [_jsxs("div", { className: "stat-label", children: [_jsx("span", { children: "Moisture" }), _jsxs("span", { children: [selectedPlot.moisture || 0, "%"] })] }), _jsx("div", { className: "stat-bar", children: _jsx("div", { className: "stat-fill moisture", style: { width: `${selectedPlot.moisture || 0}%` } }) })] })] }), plant ? (_jsxs("div", { className: "plant-info", children: [_jsx("h4", { children: plant.name }), _jsxs("div", { className: "plant-progress", children: [_jsxs("div", { className: "progress-label", children: [_jsx("span", { children: "Growth" }), _jsxs("span", { children: [growthPercent.toFixed(0), "%"] })] }), _jsx("div", { className: "progress-bar", children: _jsx("div", { className: "progress-fill", style: { width: `${growthPercent}%` } }) })] }), _jsxs("div", { className: "plant-stats", children: [_jsxs("div", { className: "plant-stat", children: [_jsx("div", { className: "stat-label", children: "Health" }), _jsxs("div", { className: "stat-value", children: [plant.health?.toFixed(0) ?? '?', "%"] })] }), _jsxs("div", { className: "plant-stat", children: [_jsx("div", { className: "stat-label", children: "Age" }), _jsxs("div", { className: "stat-value", children: [plant.age ?? '?', " ", plant.age === 1 ? 'phase' : 'phases'] })] })] }), plant.moonBlessed && _jsx("div", { className: "plant-blessing", children: "\u2727 Moon Blessed \u2727" }), plant.seasonalModifier && plant.seasonalModifier !== 1.0 && (_jsx("div", { className: "plant-season", children: plant.seasonalModifier > 1 ?
                                        ...
                                        _jsxs("span", { className: "penalty", children: ["Struggling (-", Math.round((1 - plant.seasonalModifier) * 100), "%)"] }) })), _jsx("div", { className: "garden-actions plant-actions", children: plant.mature ? (_jsx("button", { className: "action-button harvest", onClick: handleHarvest, children: _jsx("span", { children: "Harvest Plant" }) })) : (_jsxs(_Fragment, { children: [selectedPlot.moisture && selectedPlot.moisture < 50 && (_jsx("button", { className: "action-button water", onClick: handleWater, children: _jsx("span", { children: "Water Plant" }) })), (weatherFate === 'stormy' || weatherFate === 'windy') && (_jsx("button", { className: "action-button protect", onClick: handleProtect, children: _jsx("span", { children: "Protect Plant" }) }))] })) }), recommendedAction && (_jsxs("div", { className: "recommendation-hint", children: [_jsx("span", { className: "hint-icon", children: "\uD83D\uDCA1" }), _jsxs("span", { className: "hint-text", children: ["Recommended: ", recommendedAction === 'harvest' ? 'Harvest this mature plant' :
                                                    recommendedAction === 'water' ? 'This plant needs water' :
                                                        recommendedAction === 'protect' ? 'Protect from harsh weather' : ''] })] }))] })) : (_jsxs("div", { className: "empty-plot-status", children: [_jsx("p", { children: "This plot is empty." }), _jsx("p", { children: "Select a seed from your inventory to plant here." })] })), _jsxs("div", { className: "garden-actions", children: [_jsx("button", { className: "action-button attunement", onClick: handleStartAttunement, disabled: showAttunementPuzzle, children: _jsx("span", { children: "Attune Garden" }) }), _jsx("button", { className: "action-button cross-breed", onClick: handleOpenCrossBreeding, children: _jsx("span", { children: "Cross-Breeding Lab" }) })] }), _jsx("div", { className: "parchment-filler" })] })] }));
    };
    ...
    return (_jsxs("div", { className: `garden-container ${season.toLowerCase()}`, children: [_jsxs("div", { className: "garden-frame", children: [_jsxs("div", { className: "garden-header", children: [_jsx("div", { className: "scroll-ornament left" }), _jsx("h2", { children: "Witch's Garden" }), _jsx("div", { className: "scroll-ornament right" }), _jsxs("div", { className: "garden-indicators", children: [renderWeatherIndicator(), renderSeasonIndicator(), renderMoonPhaseIndicator()] })] }), _jsxs("div", { className: "garden-content", children: [_jsxs("div", { className: "garden-grid", children: [_jsx("div", { className: "grid-background" }), renderPlots(), _jsx("div", { className: "garden-secret-spot", onClick: handleSecretSpotClick })] }), _jsxs("div", { className: "garden-sidebar", children: [renderPlotDetails(), renderSeedPouch(), _jsxs("div", { className: "sidebar-decorations", children: [_jsx("div", { className: "corner-decoration top-left" }), _jsx("div", { className: "corner-decoration top-right" }), _jsx("div", { className: "corner-decoration bottom-left" }), _jsx("div", { className: "corner-decoration bottom-right" })] })] })] })] }), showWhisper && _jsx("div", { className: "garden-whisper", children: showWhisper }), attunementAnimation && _jsx("div", { className: "attunement-overlay" }), showEastEgg && _jsx("div", { className: "east-egg-overlay" }), showAttunementPuzzle && (_jsx(SeasonalAttunementPuzzle, { onComplete: handlePuzzleComplete, onSkip: handleSkipPuzzle, season: season })), showMiniGame && (_jsx(GardenMiniGame, { type: miniGameType, onComplete: handleMiniGameComplete, onCancel: handleCancelMiniGame, season: season, moonPhase: moonPhase, weather: weatherFate, playerSkill: playerSkills.gardening, plotId: selectedPlotId || 0, plantId: selectedPlantId || undefined })), showCrossBreeding && (_jsx(CrossBreedingInterface, { plants: plots.flatMap(plot => plot.plant ? [plot.plant] : []), onCrossBreed: onCrossBreed, onClose: handleCloseCrossBreeding, currentSeason: season, currentMoonPhase: moonPhase, playerGardeningSkill: playerSkills.gardening }))] }));
};
export default Garden;
//# sourceMappingURL=UpdatedGarden.js.map