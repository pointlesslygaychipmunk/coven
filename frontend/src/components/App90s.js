...
const App90s = () => {
    ...
    // Loading screen
    if (!gameLoaded) {
        return (_jsx("div", { className: "loading-screen", children: _jsxs("div", { className: "loading-content", children: [_jsx("h1", { children: "Witch's Coven" }), _jsxs("div", { className: "loading-cauldron", children: [_jsx("div", { className: "loading-bubble" }), _jsx("div", { className: "loading-bubble" }), _jsx("div", { className: "loading-bubble" })] }), _jsx("p", { children: "Brewing your magical adventure..." })] }) }));
    }
    // Main game
    return (_jsx(MainGameFrame, { playerName: mockGameData.playerName, gold: mockGameData.gold, day: mockGameData.day, lunarPhase: mockGameData.lunarPhase, reputation: mockGameData.reputation, playerLevel: mockGameData.playerLevel }));
};
export default App90s;
//# sourceMappingURL=App90s.js.map