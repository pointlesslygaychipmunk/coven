...
export const checkCornerClicks = (corner: 'topLeft' | 'topRight' | 'bottomLeft' | 'bottomRight', clickCount: number): boolean => {
...
export const generateCorruptedText = (text: string): string => {
...
export const generateBootText = (system: string, version: string): string[] => {
  return [
