...
export type GardenSlot = {
  ...
  // Environmental Factors (can be dynamic or fixed per plot)
...
export type Item = {
  ...
  category?: ItemCategory;// More specific category
  value?: number;         // Base gold value (market price will fluctuate)
  rarity?: 'common' | 'uncommon' | 'rare' | 'legendary'; // Item rarity
...
export type InventoryItem = {
  ...
  type: ItemType;
  category: ItemCategory; // Category should be mandatory for inventory items for filtering
  ...
  rarity?: 'common' | 'uncommon' | 'rare' | 'legendary'; // Rarity for reference
...
export type MarketItem = {
  ...
  description: string;    // Description for market display
